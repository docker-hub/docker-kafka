...
Take the same parameters as the docker/kafka image with some new ones:
...
https://registry.hub.docker.com/u/docker/kafka/

https://registry.hub.docker.com/u/docker/kafkaproxy/

Build from Source
---

    docker build -t docker/kafka kafka/
    docker build -t docker/kafkaproxy kafkaproxy/
